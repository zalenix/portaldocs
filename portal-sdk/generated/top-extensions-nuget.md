...
External partners can download and install the NuGet packages when they install and use **Visual Studio 2015**. For more information, see [top-extensions-getting-started.md#maintain-development-environment](top-extensions-getting-started.md#maintain-development-environment). The packages that are installed are located in the `C:\Program Files (x86)\Microsoft SDKs\PortalSDK\Packages` directory.
...
<a name="nuget-packages-available-packages"></a>
## Available Packages
...
<a name="nuget-packages-available-packages-development"></a>
### Development
...
<a name="nuget-packages-available-packages-publishing-in-the-marketplace"></a>
...
<a name="nuget-packages-available-packages-testing"></a>
### Testing
...
<a name="nuget-packages-available-packages-shared-packages"></a>
### Shared packages
...
<a name="nuget-packages-available-packages-deprecated-packages"></a>
### Deprecated packages
