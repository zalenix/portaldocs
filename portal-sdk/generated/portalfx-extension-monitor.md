...
* [Performance Overview](portalfx-performance.md#performance-overview)
    * [Extension-loading performance](portalfx-performance.md#extension-loading-performance)
...
* [Performance best practices](portalfx-performance.md#performance-best-practices)
    * [Checklist](portalfx-performance.md#checklist)
...
* [Extension load shim dependencies (removing shims)](portalfx-performance.md#extension-load-shim-dependencies-removing-shims)
    * [How to fix shim usage](portalfx-performance.md#how-to-fix-shim-usage)
* [Using the Portal's ARM token](portalfx-performance.md#using-the-portal-s-arm-token)
    * [Ensure you verify:](portalfx-performance.md#ensure-you-verify)
    * [Changes required](portalfx-performance.md#changes-required)
* [V2 targets](portalfx-performance.md#v2-targets)
    * [Prerequisites](portalfx-performance.md#prerequisites)
    * [Get your extension building with tsconfig.json](portalfx-performance.md#get-your-extension-building-with-tsconfig-json)
    * [Get extension building using V2 targets](portalfx-performance.md#get-extension-building-using-v2-targets)
    * [Enabling CloudBuild support](portalfx-performance.md#enabling-cloudbuild-support)
    * [Common errors](portalfx-performance.md#common-errors)
    * [Breaking changes between V1 and V2 targets](portalfx-performance.md#breaking-changes-between-v1-and-v2-targets)
* [Dependency injected view models](portalfx-performance.md#dependency-injected-view-models)
    * [Prerequistes](portalfx-performance.md#prerequistes)
    * [Migration steps](portalfx-performance.md#migration-steps)
    * [Pull Request Samples](portalfx-performance.md#pull-request-samples)
* [Performance profiling](portalfx-performance.md#performance-profiling)
    ...
    * [Identifying common slowdowns](portalfx-performance.md#identifying-common-slowdowns)
