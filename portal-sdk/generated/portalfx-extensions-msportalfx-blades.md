...
* [Common blades](#common-blades)

* [Locating an open blade](#locating-an-open-blade)

* [Dialogs](#dialogs)

* [Blade navigation while testing](#blade-navigation-while-testing)

* * *

<a name="blades-common-blades"></a>
### Common blades

There are several types of Portal blades that can be opened programmatically. There are also several API's that can be used to test common browse functionalities like context menu commands and column picking. 

* The spec picker blade
...
The `testfx.portal.blade` method can be used to locate a currently opened blade.

*  Locate an previously-opened blade by its  title, as in the following example.
...
* Locate an previously-opened blade by using its blade type and its predefined locator, as in the following example.
...
Some blades commands create dialogs that typically require an acknowledgement from the user. The `Blade` class exposes a `dialog` function that can be used to locate the dialog on the specified blade, and to perform actions against it. 
...
<a name="blades-blade-navigation-while-testing"></a>
### Blade navigation while testing
