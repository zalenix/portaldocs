...
<a name="styling-an-extension-html-and-css-sanitization"></a>
...
<a name="styling-an-extension-html-and-css-sanitization-html-sanitization"></a>
### HTML sanitization

HTML sanitization is divided between HTML tags and their attributes.

<a name="styling-an-extension-html-and-css-sanitization-html-tags"></a>
### HTML tags

The `iframe` tag is not allowed based on criterion 3.

<a name="styling-an-extension-html-and-css-sanitization-html-attributes"></a>
### HTML attributes
...
<a name="styling-an-extension-html-and-css-sanitization-css-sanitization"></a>
### CSS sanitization
...
<a name="styling-an-extension-html-and-css-sanitization-svg-sanitization"></a>
### SVG sanitization
...
<a name="styling-an-extension-layout-classes"></a>
## Layout classes
...
<a name="styling-an-extension-layout-classes-controls-that-help-out-with-layout"></a>
...
<a name="styling-an-extension-typography"></a>
## Typography
...
The typography guidelines are located at [https://docs.microsoft.com/en-us/windows/uwp/design/style/typography](https://docs.microsoft.com/en-us/windows/uwp/design/style/typography).
...
<a name="styling-an-extension-iconography"></a>
## Iconography
...
<a name="styling-an-extension-iconography-customizing-the-extension"></a>
...
<a name="styling-an-extension-iconography-customizing-the-extension-color-palettes"></a>
#### Color Palettes
...
<a name="styling-an-extension-iconography-customizing-the-extension-custom-data-binding"></a>
#### Custom data binding
...
<a name="styling-an-extension-iconography-customizing-the-extension-preserve-icon-colors-over-theme-changes"></a>
...
<a name="styling-an-extension-iconography-msportalfx-base-images"></a>
...
<a name="styling-an-extension-iconography-using-the-built-in-svg-s"></a>
...
<a name="styling-an-extension-iconography-using-the-custom-svg-s"></a>
...
<a name="styling-an-extension-iconography-creating-icons"></a>
### Creating icons
...
<a name="styling-an-extension-iconography-svg-tags"></a>
### SVG tags
...
<a name="styling-an-extension-iconography-using-built-in-icons"></a>
...
<a name="styling-an-extension-theming-text-color-classes"></a>
### Text color classes
...
<a name="styling-an-extension-utility-classes-classes"></a>
### Classes
