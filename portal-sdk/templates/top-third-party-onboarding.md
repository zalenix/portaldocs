...
When you receive the approval, you can submit a third-party request by reaching out to <a href="mailto:ibiza-onboarding@microsoft.com?subject=New%20Third%20Party%20Extension"> ibizafxpm@microsoft.com o </a> instead of using the internal sites that are in this document. The body of the email should contain the following.
